...
export default function SHA1HashPage() {
  ...
  return (
    <ToolLayout
      ...
      description="Generate SHA1 hash from text instantly"
      category="Hash Tools"
    >
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label htmlFor="output">SHA1 Hash</Label>
            {output && (
              <div className="flex gap-2">
                <CopyButton text={output} />
                <DownloadButton content={output} filename="sha1-hash.txt" />
              </div>
            )}
          </div>
          <Textarea
        ...
        <div className="text-sm text-muted-foreground bg-muted p-4 rounded-md">
          <p className="font-semibold mb-2">About SHA1:</p>
          <ul className="list-disc list-inside space-y-1">
            <li><strong>SHA1</strong> produces a 160-bit (40-character) hash</li>
            <li>Deprecated for security purposes</li>
            <li>Use for checksums and legacy systems only</li>
