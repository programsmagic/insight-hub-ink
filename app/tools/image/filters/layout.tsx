...
const metadataConfig = generateToolMetadataComplete({
  ...
  features: ["Apply filters","Multiple effects","Real-time preview","Professional results"],
  faqs: [
    {
...
export default function ImageFiltersLayout({
  ...
  return (
    <>
      <Script
        id="image-filters-structured-data"
