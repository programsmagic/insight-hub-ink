...
const metadataConfig = generateToolMetadataComplete({
  ...
  features: ["Rotate images","90, 180, 270 degrees","Preserve quality","Quick rotation"],
  faqs: [
    {
...
export default function ImageRotatorLayout({
  ...
  return (
    <>
      <Script
        id="image-rotator-structured-data"
