...
const tool = getToolById("image-blur");
if (!tool) throw new Error("Tool not found");

const metadataConfig = generateToolMetadataComplete({
  tool,
  categoryName: "Image Tools",
  features: ["Apply blur","Adjustable intensity","Multiple blur types","Professional effects"],
  faqs: [
    {
