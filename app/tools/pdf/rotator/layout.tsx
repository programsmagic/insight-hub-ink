...
const tool = getToolById("pdf-rotator");
if (!tool) throw new Error("Tool not found");

const metadataConfig = generateToolMetadataComplete({
  tool,
  categoryName: "PDF Tools",
  features: ["Rotate pages","90, 180, 270 degrees","Select pages","Batch rotation"],
  faqs: [
    {
...
export default function PdfRotatorLayout({
  ...
  return (
    <>
      <Script
        id="pdf-rotator-structured-data"
