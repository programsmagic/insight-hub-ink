...
export default function SlugGeneratorPage() {
  ...
  return (
    <ToolLayout
      ...
      description="Generate URL-friendly slugs from text for use in web addresses and filenames"
      category="Text Tools"
    >
      <div className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button onClick={handleGenerate} size="sm" className="shadow-md">
                  Generate Slug
                </Button>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <Label htmlFor="output" className="text-base">Generated Slug</Label>
              {output && (
                <div className="flex gap-2">
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1">
              ...
              <ul className="list-none space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-1">•</span>
                  <span className="text-muted-foreground">Click "Generate Slug" to create a URL-friendly version</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-1">•</span>
                  <span className="text-muted-foreground">Special characters are removed and spaces become hyphens</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-1">•</span>
                  <span className="text-muted-foreground">Copy or download the slug result</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-1">•</span>
                  <span className="text-muted-foreground">Perfect for creating SEO-friendly URLs and filenames</span>
                </li>
              </ul>
            </div>
          </div>
